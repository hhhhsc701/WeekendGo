...
class Settings(BaseSettings):
    ...
    openai_timeout_seconds: float = Field(default=1800.0, alias="OPENAI_TIMEOUT_SECONDS")
    generation_timeout_seconds: float = Field(default=1800.0, alias="GENERATION_TIMEOUT_SECONDS")
